...
((mojo.internal.kArrayHeaderSize = 8),
  ...
  (mojo.internal.kHostLittleEndian = !!new Uint8Array(
  ...
  (mojo.internal.setInt64 = function (e, n, t) {
    mojo.internal.kHostLittleEndian
      ? (e.setUint32(
          n,
          Number(BigInt(t) & BigInt(4294967295)),
          mojo.internal.kHostLittleEndian,
        ),
        e.setInt32(
          n + 4,
          Number((BigInt(t) >> BigInt(32)) & BigInt(4294967295)),
          mojo.internal.kHostLittleEndian,
        ))
      : (e.setInt32(
          n,
  ...
  (mojo.internal.getInt64 = function (e, n) {
    ...
    return (
      mojo.internal.kHostLittleEndian
        ? ((t = e.getUint32(n, mojo.internal.kHostLittleEndian)),
          (o = e.getInt32(n + 4, mojo.internal.kHostLittleEndian)))
        : ((t = e.getUint32(n + 4, mojo.internal.kHostLittleEndian)),
  ...
  (mojo.internal.getUint64 = function (e, n) {
    ...
    return (
      mojo.internal.kHostLittleEndian
        ? ((t = e.getUint32(n, mojo.internal.kHostLittleEndian)),
          (o = e.getUint32(n + 4, mojo.internal.kHostLittleEndian)))
        : ((t = e.getUint32(n + 4, mojo.internal.kHostLittleEndian)),
  ...
  (mojo.internal.computeStructDimensions = function (e, n) {
    ...
    for (const i of e.fields) {
      ...
      if (
        (mojo.internal.isNullOrUndefined(e) && (e = i.defaultValue), null !== e)
      )
    ...
    return { size: t, numInterfaceIds: o };
  }),
  (mojo.internal.computeUnionDimensions = function (e, n, t) {
    ...
    if (1 !== r.length)
      throw new Error(
        `Value for ${e.name} must be an Object with a single property named one of: ` +
    ...
    return { size: o, numInterfaceIds: i };
  }),
  (mojo.internal.computeInlineArraySize = function (e, n) {
    return e.elementType === mojo.internal.Bool
      ? mojo.internal.kArrayHeaderSize +
          mojo.internal.computeHasValueBitfieldSize(e, n.length) +
          ((n.length + 7) >> 3)
      : mojo.internal.kArrayHeaderSize +
          mojo.internal.computeHasValueBitfieldSize(e, n.length) +
          n.length * e.elementType.$.arrayElementSize(!!e.elementNullable);
  }),
  ...
  (mojo.internal.computeTotalArraySize = function (e, n) {
    ...
    let o = t;
    for (let t of n)
      mojo.internal.isNullOrUndefined(t) ||
        (o += mojo.internal.align(
          e.elementType.$.computeDimensions(t, !!e.elementNullable).size,
          8,
        ));
    return o;
  }),
  (mojo.internal.Message = class {
    constructor(e, n, t, o, i, r, s) {
      ...
      let l, c;
      a.numInterfaceIds > 0
        ? ((l = mojo.internal.kMessageV2HeaderSize), (c = 2))
        : t &
            (mojo.internal.kMessageFlagExpectsResponse |
              mojo.internal.kMessageFlagIsResponse)
          ? ((l = mojo.internal.kMessageV1HeaderSize), (c = 1))
          : ((l = mojo.internal.kMessageV0HeaderSize), (c = 0));
      const d = l + a.size,
        u =
          a.numInterfaceIds > 0
            ? mojo.internal.kArrayHeaderSize + 4 * a.numInterfaceIds
            : 0,
      ...
      (m.setUint32(0, l, mojo.internal.kHostLittleEndian),
        ...
        m.setUint32(20, 0),
        c >= 1 &&
          (mojo.internal.setUint64(m, 24, i),
          c >= 2 &&
            (mojo.internal.setUint64(m, 32, BigInt(16)),
        ...
        a.numInterfaceIds &&
          (this.interfaceIds_ = new Uint32Array(
            this.buffer,
            d + mojo.internal.kArrayHeaderSize,
            a.numInterfaceIds,
          )),
        (this.nextAllocationOffset_ = l));
      const f = this.allocate(r.packedSize);
      new mojo.internal.Encoder(this, f, { endpoint: e }).encodeStructInline(
        r,
        s,
      );
    }
  ...
  (mojo.internal.Encoder = class {
    ...
    encodeString(e, n) {
      ...
      this.encodeArray(
        ...
        e,
        mojo.internal.Encoder.stringToUtf8Bytes(n),
      );
    }
    encodeOffset(e, n) {
    ...
    encodeArray(e, n, t) {
      ...
      if (e.elementType === mojo.internal.Bool) {
        let e = 0;
        for (const n of t)
          (r.encodeBool(s, e, n), e++, 8 == e && ((e = 0), s++));
      } else
        for (const n of t) {
          if (null === n) {
            if (!e.elementNullable)
              throw new Error(
                "Trying to send a null element in an array of non-nullable elements",
              );
    ...
    encodeMap(e, n, t) {
      let o, i;
      "Map" == t.constructor.name
        ? ((o = Array.from(t.keys())), (i = Array.from(t.values())))
        : ((o = Object.keys(t)), (i = o.map((e) => t[e])));
      ...
      (this.encodeOffset(n, r.byteOffset),
        ...
        s.encodeUint32(4, 0),
        s.encodeArray({ elementType: e.keyType }, 8, o),
        s.encodeArray(
          { elementType: e.valueType, elementNullable: e.valueNullable },
          16,
          i,
        ));
    }
    ...
    encodeStructInline(e, n) {
      ...
      for (const t of e.fields) {
        const o = mojo.internal.kStructHeaderSize + t.packedOffset,
          ...
          r = mojo.internal.isNullOrUndefined(n)
            ? void 0
            : mojo.internal.getMojoFieldValue(n, t);
        if (
          mojo.internal.isNullOrUndefined(n) ||
          mojo.internal.isNullOrUndefined(r)
        )
    ...
    encodeUnion(e, n, t) {
      ...
      void 0 === r.type.$.unionSpec
        ? r.type.$.encode(t[i], this, s, 0, r.nullable)
        : this.encodeUnionAsPointer(r.type.$.unionSpec, s, t[i]);
    }
    static stringToUtf8Bytes(e) {
      return (
        mojo.internal.Encoder.textEncoder ||
  ...
  (mojo.internal.Decoder = class {
    ...
    decodeString(e) {
      ...
      return n
        ? (mojo.internal.Decoder.textDecoder ||
            (mojo.internal.Decoder.textDecoder = new TextDecoder("utf-8")),
          mojo.internal.Decoder.textDecoder.decode(new Uint8Array(n).buffer))
        : null;
    }
    decodeOffset(e) {
    ...
    decodeArray(e, n) {
      ...
      if (!t) return null;
      const o = new mojo.internal.Decoder(
          new DataView(this.data_.buffer, t),
          this.handles_,
          this.context_,
        ),
        i = o.decodeUint32(4);
      ...
      if (r) {
        let e = 8,
          n = 0;
        for (let t = 0; t < i; ++t)
          (s.push(o.decodeBool(e, n)), n++, 8 === n && ((n = 0), e++));
      }
    ...
    decodeMap(e, n) {
      ...
      const s = o.decodeArray({ elementType: e.keyType }, 8),
        a = o.decodeArray(
          { elementType: e.valueType, elementNullable: e.valueNullable },
          16,
        );
    ...
    decodeStruct(e, n) {
      const t = this.decodeOffset(n);
      if (!t) return null;
      return new mojo.internal.Decoder(
        new DataView(this.data_.buffer, t),
        this.handles_,
        this.context_,
    ...
    wrapStructInDataView(e, n, t) {
      ...
      if (!o) return null;
      const i = new mojo.internal.Decoder(
          new DataView(this.data_.buffer, o),
          this.handles_,
          this.context_,
        ),
      ...
      if (!i.isStructHeaderValid(e, r, s))
        throw new Error(
          `Received ${e.name} of invalid size (${r}) and/or version (${s})`,
        );
    ...
    decodeStructInline(e) {
      ...
      if (!this.isStructHeaderValid(e, n, t))
        throw new Error(
          `Received ${e.name} of invalid size (${n}) and/or version (${t})`,
        );
      const o = {};
      for (let n = 0; n < e.fields.length; ++n) {
        ...
        if (mojo.internal.isNullableValueKindField(i)) {
          ...
          {
            const r = i;
            o[n.originalFieldName] = this.decodeStructNullableValueField(
              r,
              e.fields,
              t,
            );
      ...
      return e.minVersion > n
        ...
        : ((e) => {
            ...
            if (null === t && !e.nullable)
              throw new Error(
                `Received ${e.name} with invalid null field "${e.name}"`,
              );
            return t;
          })(e);
    }
      ...
      for (const o in e.fields) {
        ...
        if (i.ordinal === t) {
          const t = (() => {
            ...
            return void 0 !== i.type.$.unionSpec
              ? this.decodeUnionFromPointer(i.type.$.unionSpec, e)
              : i.type.$.decode(this, e, 0, i.nullable);
          })();
          if (null === t && !i.nullable)
            throw new Error(
              `Received ${e.name} with invalid null field: ${i.name}`,
            );
          const r = {};
          return ((r[o] = t), r);
        }
    ...
    decodeAssociatedEndpoint(e) {
      if (!this.context_ || !this.context_.endpoint)
        throw new Error(
          "cannot deserialize associated endpoint without context",
        );
      const n = this.context_.endpoint,
        ...
        r = new Uint32Array(
          t.buffer,
          o + mojo.internal.kArrayHeaderSize + 40,
          i,
        )[this.decodeUint32(e)],
  ...
  (mojo.internal.deserializeMessageHeader = function (e) {
    ...
    if (
      (0 == t && n != mojo.internal.kMessageV0HeaderSize) ||
      (1 == t && n != mojo.internal.kMessageV1HeaderSize) ||
      (t >= 2 && n < mojo.internal.kMessageV2HeaderSize)
    )
  ...
  (mojo.internal.Array = function (e, n) {
    const t = { elementType: e, elementNullable: n };
    return {
      $: {
        arraySpec: t,
  ...
  (mojo.internal.Map = function (e, n, t) {
    const o = { keyType: e, valueType: n, valueNullable: t };
    return {
      $: {
        mapSpec: o,
        ...
        computeDimensions: function (o, i) {
          ...
          return {
            size:
              ...
              mojo.internal.align(
                mojo.internal.computeTotalArraySize({ elementType: e }, r),
                8,
              ) +
              mojo.internal.computeTotalArraySize(
                { elementType: n, elementNullable: t },
                s,
              ),
          };
        },
  ...
  (mojo.internal.Struct = function (e, n, t, o) {
    const i = o.map((e) => ({ version: e[0], packedSize: e[1] })),
      r = {
        name: n,
  ...
  (mojo.internal.TypemappedStruct = function (e, n, t, o, i, r) {
    const s = r.map((e) => ({ version: e[0], packedSize: e[1] })),
      a = {
        name: n,
  ...
  (mojo.internal.createStructDeserializer = function (e) {
    return function (n) {
      ...
      return new mojo.internal.Decoder(n, []).decodeStructInline(
        e.$.structSpec,
      );
    };
  }),
  (mojo.internal.Union = function (e, n, t) {
    const o = { name: n, fields: t };
    e.$ = {
      unionSpec: o,
      encode: function (e, n, t, i, r) {
        n.encodeUnion(o, t, e);
  ...
  (mojo.internal.AssociatedInterfaceProxy = function (e) {
    return {
      $: {
        ...
        encode: function (n, t, o, i, r) {
          (console.assert(
            n.proxy.endpoint && n.proxy.endpoint.isPendingAssociation,
            `expected ${e.name} to be associated and unbound`,
          ),
        ...
        arrayElementSize: (e) => {
          throw new Error(
            "Arrays of associated endpoints are not yet supported",
          );
        },
        isValidObjectKeyType: !1,
        hasInterfaceId: !0,
  ...
  (mojo.internal.AssociatedInterfaceRequest = function (e) {
    return {
      $: {
        ...
        encode: function (n, t, o, i, r) {
          (console.assert(
            n.handle && n.handle.isPendingAssociation,
            `expected ${e.name} to be associated and unbound`,
          ),
  ...
  mojo.internal.Union(
    ...
    "RunOrClosePipeInput",
    {
      ...
      messageAck: { ordinal: 2, type: mojo.interfaceControl.MessageAckSpec.$ },
      notifyIdle: { ordinal: 3, type: mojo.interfaceControl.NotifyIdleSpec.$ },
    },
  ),
  ...
  mojo.internal.Struct(
    ...
    [
      mojo.internal.StructField("id", 0, 0, mojo.internal.Uint32, 0, !1, 0),
      mojo.internal.StructField(
        "disconnectReason",
        8,
        0,
  ...
  mojo.internal.Union(
    ...
    "RunOrClosePipeInput",
    {
      ...
      flushAsync: { ordinal: 2, type: mojo.pipeControl.FlushAsyncSpec.$ },
    },
  ),
  ...
  (mojo.internal.interfaceSupport.Router = class {
    constructor(e, n) {
      ((this.pipe_ = e),
        ...
        (this.interfaceIdNamespace_ = n
          ? mojo.internal.kInterfaceNamespaceBit
          : 0),
        (this.pipeControlHandler_ =
          new mojo.internal.interfaceSupport.PipeControlMessageHandler(
            this,
            this.onPeerEndpointClosed_.bind(this),
          )));
    }
    get pipe() {
      return this.pipe_;
    ...
    addEndpoint(e, n) {
      (0 === n && this.reader_.start(),
        console.assert(
          this.isReading(),
          "adding a secondary endpoint with no primary",
        ),
    ...
    closeEndpoint(e) {
      (this.removeEndpoint(e),
        0 === e
          ? this.close()
          : this.pipeControlHandler_.notifyEndpointClosed(e));
    }
    isReading() {
    ...
    onMessageReceived_(e, n) {
      ...
      this.pipeControlHandler_.maybeHandleMessage(t, e) ||
        (this.messages_.push({ header: t, buffer: e, handles: n }),
        this.dispatchMessages_());
    }
    checkSize_(e) {
      return (
        !(e.byteLength < mojo.internal.kMessageV0HeaderSize) ||
        (console.error("Rejecting undersized message"), this.onError_(), !1)
      );
    }
    dispatchMessages_() {
    ...
    dispatch_(e) {
      ...
      return n
        ? !!n.isStarted &&
            (n.onMessageReceived(e.header, e.buffer, e.handles), !0)
        : (console.error(
            `Received message for unknown endpoint ${e.header.interfaceId}`,
          ),
          !1);
    }
    onError_() {
  ...
  (mojo.internal.interfaceSupport.Endpoint = class {
    ...
    releasePipe() {
      return (
        console.assert(
          this.isPrimary(),
          "secondary endpoint cannot release pipe",
        ),
        this.router_.pipe
      );
    }
    ...
    send(e, n, t, o, i) {
      const r = new mojo.internal.Message(
        this,
        this.interfaceId_,
        t,
        e,
      ...
      (console.assert(
        this.router_,
        "cannot send message on unassociated unbound endpoint",
      ),
        this.router_.send(r));
    }
    start(e) {
    ...
    onMessageReceived(e, n, t) {
      ...
      this.controlMessageHandler_.maybeHandleControlMessage(e, n) ||
        this.client_.onMessageReceived(this, e, n, t);
    }
    onError() {
  ...
  (mojo.internal.interfaceSupport.PipeControlMessageHandler = class {
    ...
    send(e) {
      const n = new mojo.internal.Message(
        null,
        4294967295,
        0,
    ...
    maybeHandleMessage(e, n) {
      ...
      return (
        !r.hasOwnProperty("peerAssociatedEndpointClosedEvent") ||
        (this.onDisconnect_(r.peerAssociatedEndpointClosedEvent.id), !0)
      );
    }
  ...
  (mojo.internal.interfaceSupport.ControlMessageHandler = class {
    constructor(e) {
      ((this.endpoint_ = e), (this.pendingFlushResolvers_ = new Map()));
    }
    sendRunMessage(e) {
    ...
    maybeHandleControlMessage(e, n) {
      if (e.ordinal === mojo.interfaceControl.RUN_MESSAGE_ID) {
        const t = new DataView(n, e.headerSize),
          o = new mojo.internal.Decoder(t, []);
        return e.flags & mojo.internal.kMessageFlagExpectsResponse
          ? this.handleRunRequest_(e.requestId, o)
          : this.handleRunResponse_(e.requestId, o);
      }
      return !1;
    }
    handleRunRequest_(e, n) {
      return (
        !!n
          .decodeStructInline(
            mojo.interfaceControl.RunMessageParamsSpec.$.$.structSpec,
          )
          .input.hasOwnProperty("flushForTesting") &&
        (this.endpoint_.send(
          mojo.interfaceControl.RUN_MESSAGE_ID,
          e,
          mojo.internal.kMessageFlagIsResponse,
  ...
  (mojo.internal.interfaceSupport.ConnectionErrorEventRouter = class {
    constructor() {
      ((this.listeners = new Map()), (this.nextListenerId_ = 0));
    }
    addListener(e) {
  ...
  (mojo.internal.interfaceSupport.InterfaceRemoteBase = class {
    ...
    bindNewPipeAndPassReceiver() {
      let { handle0: e, handle1: n } = 0; //Mojo.createMessagePipe();
      return (
        this.bindHandle(e),
    ...
    sendMessage(e, n, t, o, i) {
      ...
      if (
        (this.endpoint_.send(
          e,
          a,
          t ? mojo.internal.kMessageFlagExpectsResponse : 0,
          n,
          r,
        ),
        !t)
    ...
    onMessageReceived(e, n, t, o) {
      if (
        !(n.flags & mojo.internal.kMessageFlagIsResponse) ||
        n.flags & mojo.internal.kMessageFlagExpectsResponse
      )
        return this.onError(e, "Received unexpected request message");
      const i = this.pendingResponses_.get(n.requestId);
      if ((this.pendingResponses_.delete(n.requestId), !i))
  ...
  (mojo.internal.interfaceSupport.CallbackRouter = class {
    constructor() {
      ((this.removeCallbacks = new Map()), (this.nextListenerId_ = 0));
    }
    getNextId() {
  ...
  (mojo.internal.interfaceSupport.InterfaceCallbackReceiver = class {
    constructor(e) {
      ((this.listeners_ = new Map()), (this.callbackRouter_ = e));
    }
    addListener(e) {
      const n = this.callbackRouter_.getNextId();
      return (
        this.listeners_.set(n, e),
        this.callbackRouter_.removeCallbacks.set(n, () =>
          this.listeners_.delete(n),
        ),
        n
      );
    }
    createReceiverHandler(e) {
      return e
        ? this.dispatchWithResponse_.bind(this)
        : this.dispatch_.bind(this);
    }
    dispatch_(e) {
    ...
    dispatchWithResponse_(e) {
      ...
      for (const e of t)
        if (void 0 !== e) {
          if (void 0 !== o)
            throw new Error(
              "Multiple listeners attempted to reply to a message",
            );
          o = e;
        }
      return o;
  ...
  (mojo.internal.interfaceSupport.InterfaceReceiverHelperInternal = class {
    ...
    onMessageReceived(e, n, t, o) {
      ...
      i.useResultResponse
        ? this.handleResultResponseMessage_(e, n, i, s)
        : this.handleResponseMessage_(e, n, i, s);
    }
    handleResultResponseMessage_(e, n, t, o) {
      try {
        let i = t.handler.apply(null, o);
        (("object" == typeof i && "Promise" == i.constructor.name) ||
          (i = Promise.resolve(i)),
          i
            .then((o) => {
              e.send(
